          ...
          if (statsData && Array.isArray(statsData)) {
            const enhancedContributors = contributorsData.map((contributor) => {
              ...
              if (contributorStats) {
                return {
                  ...contributor,
                  contributions: contributorStats.commits || contributor.contributions || 0, // Use commits from stats if available
      ...
      <div className="container mx-auto px-4 py-8 space-y-8 flex-grow">
        ...
        {searchPerformed && !loading && contributors.length > 0 && (
          ...
          >
            ...
            <motion.div custom={4} variants={statsCardVariants}>
              <Card className="border shadow-neumorph dark:shadow-neumorph-dark transition-all duration-300 hover:scale-105 bg-card overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
            ...
            <motion.div custom={5} variants={statsCardVariants}>
              <Card className="border shadow-neumorph dark:shadow-neumorph-dark transition-all duration-300 hover:scale-105 bg-card overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardContent className="pt-2">
                        ...
                        <div className="mt-6 pt-4 border-t border-border">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="bg-background/60 backdrop-blur-sm p-3 rounded-md flex flex-col items-center">
